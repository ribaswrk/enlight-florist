...
export default function AboutUs() {
	return (
		<>
			<Head>
				<title>Tentang Kami - Enlight Florist, Toko Bunga Tangerang</title>
				<meta
					name="description"
					content="Pelajari kisah Enlight Florist, toko bunga terpercaya di Tangerang yang menyediakan rangkaian bunga berkualitas dengan pelayanan penuh cinta dan perhatian."
				/>
				<meta
					name="keywords"
					content="tentang Enlight Florist, kisah toko bunga Tangerang, florist Tangerang, toko bunga profesional"
				/>
				<meta name="robots" content="index, follow" />
				<meta property="og:title" content="Tentang Kami - Enlight Florist" />
				<meta
					property="og:description"
					content="Enlight Florist, toko bunga profesional di Tangerang yang menyediakan rangkaian bunga segar dan dekorasi untuk berbagai acara."
				/>
				<meta property="og:type" content="website" />
				<meta
					property="og:url"
					content="https://www.enlightflorist.com/about-us"
				/>
				<meta
					property="og:image"
					content="https://www.enlightflorist.com/og-about-us.jpg" // Pastikan gambar ini ada di server
				/>
				<link rel="canonical" href="https://www.enlightflorist.com/about-us" />
			</Head>
						...
						<div className="flex flex-col items-center justify-between gap-12 md:flex-row">
							<div className="md:w-1/2">
								...
								<p className="mt-4 text-gray-600">
									...
									buket, balon dekoratif, vas bunga, papan ucapan, hingga
									layanan dekorasi untuk berbagai acara spesial.
								</p>
								<p className="mt-4 text-gray-600">
									Dengan komitmen dan ketulusan, setiap rangkaian bunga kami
									buat secara personal untuk menemani momen berharga Anda.
									Kepuasan pelanggan adalah prioritas utama kami, karena kami
									percaya bahwa setiap bunga membawa pesan dan perasaan yang tak
									tergantikan.
								</p>
							</div>
						</div>
					...
					<div className="container mx-auto px-4">
						...
						<div className="grid gap-8 md:grid-cols-3">
							<div className="rounded-lg bg-white p-8 text-center shadow-sm transition-all hover:shadow-md">
								...
								<p className="mt-4 text-gray-600">
									Kami menyediakan berbagai macam pilihan bunga dan tidak
									terpaku pada produk yang kami tampilkan di katalog, anda bisa
									merubah warna, jenis bunga dan lain lain sesuai dengan
									keinginan anda
								</p>
							</div>
							<div className="rounded-lg bg-white p-8 text-center shadow-sm transition-all hover:shadow-md">
							...
							<div className="rounded-lg bg-white p-8 text-center shadow-sm transition-all hover:shadow-md">
								...
								<p className="mt-4 text-gray-600">
									...
									bagi kami bukan sekadar hasil akhir, tapi pengalaman
									menyeluruh yang memuaskan dan tahan lama.
								</p>
							</div>
						</div>
					</div>
