                ...
                <div className="mb-6 flex">
                  ...
                  <div>
                    ...
                    <p className="mt-2 text-gray-600">
                      ...
                      bunga, warna kertas, atau barang apa yang ingin dimasukan
                      kedalam rangkaian bunga kami, apapun itu kami akan
                      berusaha sebaik mungkin untuk mewujudkannya.
                    </p>
                  </div>
                </div>
                <div className="mb-6 flex">
                  ...
                  <div>
                    ...
                    <p className="mt-2 text-gray-600">
                      Setelah anda memberikan kami detail yang diinginkan, kami
                      juga akan memberikan saran terbaik yang kami miliki untuk
                      bunga impian anda, kami juga akan memberikan estimasi
                      harganya kepada anda
                    </p>
                  </div>
                </div>
        ...
        <div className="container mx-auto px-4">
          <div className="rounded-lg bg-[#9f6564]/10 p-8 text-center shadow-sm md:p-12">
            ...
            <p className="mx-auto mt-6 max-w-2xl text-gray-600">
              ...
              anda. Segera hubungi kami dengan menekan tombol dibawah ini, Anda
              akan langsung diarahakn ke Whatsapp kami.
            </p>
