...
export default function Corporate() {
	return (
		<>
			<Head>
				<title>
					Kerja Sama Corporate - Keuntungan Partnership dengan Enlight Florist
				</title>
				<meta
					name="description"
					content="Jalin kerja sama corporate dengan Enlight Florist dan dapatkan harga spesial, hampers eksklusif, pembayaran tempo, dan program membership menarik. Hubungi kami sekarang!"
				/>
				<meta
					name="keywords"
					content="kerja sama corporate, partnership florist, harga spesial corporate, hampers perusahaan, pembayaran tempo, program membership, Enlight Florist"
				/>
					...
					<div className="container mx-auto px-4">
						<div className="mx-auto max-w-3xl text-center">
							...
							<p className="mt-6 text-gray-600">
								...
								perusahaan (PT) atau brand yang membutuhkan rangkaian bunga
								untuk berbagai keperluan, seperti ucapan selamat, dukacita, atau
								hadiah bagi rekan bisnis dan klien.
							</p>
							<p className="mt-4 text-gray-600">
								...
								berkelanjutan. Hubungi tim kami untuk mendiskusikan kebutuhan
								Anda dan temukan solusi terbaik yang sesuai dengan brand atau
								perusahaan Anda.
							</p>
						</div>
					</div>
					...
					<div className="container mx-auto px-4">
						...
						<div className="grid gap-8 md:grid-cols-2">
							...
							<div className="rounded-lg bg-white p-8 shadow-sm transition-all hover:shadow-md">
								...
								<p className="mt-4 text-gray-600">
									Kami siap menerima pesanan dalam jumlah banyak untuk hari
									besar atau event perusahaan.
								</p>
							</div>
							...
							<div className="rounded-lg bg-white p-8 shadow-sm transition-all hover:shadow-md">
								...
								<p className="mt-4 text-gray-600">
									Setiap pembelian produk ke-sepuluh anda akan mendapatkan
									gratis 1 rangkaian bunga.
								</p>
							</div>
						</div>
					</div>
				...
				<section className="bg-gray-50 py-16">
					<div className="container mx-auto px-4">
						<div className="mb-12 text-center">
							...
							<div className="mx-auto mt-2 h-0.5 w-16 bg-[#9f6564]"></div>
							<p className="mx-auto mt-4 max-w-2xl text-gray-600">
								Berikut beberapa perusahaan yang sudah pernah memesan produk
								kami
							</p>
						</div>
				...
				<section className="py-16">
					<div className="container mx-auto px-4">
						...
						<div className="mx-auto max-w-3xl text-center text-gray-700">
							Caranya sangat mudah, cukup hubungi kami melalui Whatsapp, lalu
							kami siap kerja sama apa yang anda butuhkan dan kami siap menjalin
							kerja sama yang baik dengan perusahaan anda.
						</div>
					</div>
				</section>
